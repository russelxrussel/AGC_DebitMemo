...
Public Class repCheckPaymentRequest
    ...
    Private Sub repVoucherReceipt_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        RptDocument.Load(Application.StartupPath & "\Reports\repCheckForm.rpt")
        RptDocument.SetParameterValue("VoucherNum", VOUCHER_NUMBER)
