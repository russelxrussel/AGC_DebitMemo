...
Public Class repDMPerItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DGMU_DEBIT_TICKET_PROJ.repDMPerItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepDMPerItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repDMPerItem = New repDMPerItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
