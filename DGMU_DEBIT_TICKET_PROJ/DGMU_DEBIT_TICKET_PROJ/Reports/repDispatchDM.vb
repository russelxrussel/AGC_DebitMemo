...
Public Class repDispatchDM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DGMU_DEBIT_TICKET_PROJ.repDispatchDM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepDispatchDM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repDispatchDM = New repDispatchDM()
        rpt.Site = Me.Site
        Return rpt
    End Function
