...
Public Class repApprovedDM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DGMU_DEBIT_TICKET_PROJ.repApprovedDM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paramDMRNum() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepApprovedDM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repApprovedDM = New repApprovedDM()
        rpt.Site = Me.Site
        Return rpt
    End Function
