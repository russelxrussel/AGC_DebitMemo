...
Public Class repCheckForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DGMU_DEBIT_TICKET_PROJ.repCheckForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VoucherNum() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepCheckForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCheckForm = New repCheckForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
